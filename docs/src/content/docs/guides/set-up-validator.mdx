...
:::note
You only need one machine to run your Ethereum validator with `kittynode validator init`, but this guide will show you how to use another machine to monitor your validator with [Tailscale](https://tailscale.com/).
:::
...
2. Install and sign in to [Tailscale](https://tailscale.com/) on each machine. Note the MagicDNS or Tailscale IP.
